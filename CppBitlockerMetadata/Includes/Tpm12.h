...
///
using  TPM_FAMILY_OPERATION = UINT32;
...
//   TPM_ALG_MGF1
//
enum TPM_ALGORITHM_ID : UINT32 {
    TPM_ALG_RSA     = 0x00000001, // The RSA algorithm
    TPM_ALG_DES     = 0x00000002, // The DES algorithm
    TPM_ALG_3DES    = 0x00000003, // The 3DES algorithm in EDE mode
    TPM_ALG_SHA     = 0x00000004, // The SHA1 algorithm
    TPM_ALG_HMAC    = 0x00000005, // The RFC 2104 HMAC algorithm
    TPM_ALG_AES128  = 0x00000006, // The AES algorithm, key size 128
    TPM_ALG_MGF1    = 0x00000007, // The XOR algorithm using MGF1 to create a string the size of the encrypted block
...
///
using  TPM_DAA_TPM_SEED = TPM_NONCE;
///
/// This SHALL be a random value
///
using  TPM_DAA_CONTEXT_SEED = TPM_NONCE;
...
///
struct TPM_CHANGEAUTH_VALIDATE{
...
///
using  TPM_LOCALITY_SELECTION = UINT8;
...
///
struct TPM_DELEGATE_OWNER_BLOB{
  TPM_STRUCTURE_TAG      tag;
  TPM_DELEGATE_PUBLIC    pub;
  TPM_DIGEST             integrityDigest;
  UINT32                 additionalSize;
